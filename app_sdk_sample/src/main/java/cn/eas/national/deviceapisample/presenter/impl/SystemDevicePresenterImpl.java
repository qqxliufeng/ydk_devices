...
import cn.eas.national.deviceapisample.device.SystemDeviceImpl;
...
public class SystemDevicePresenterImpl implements ISystemDevicePresenter {
    ...
    public SystemDevicePresenterImpl(BaseDeviceActivity deviceView) {
        this.view = deviceView;
        this.systemDevice = new SystemDeviceImpl(deviceView) {
            @Override
