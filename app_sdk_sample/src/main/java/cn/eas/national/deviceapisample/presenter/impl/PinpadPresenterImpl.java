...
import cn.eas.national.deviceapisample.device.PinpadImpl;
...
public class PinpadPresenterImpl implements IPinpadPresenter {
    ...
    public PinpadPresenterImpl(BaseDeviceActivity deviceView, String deviceName) {
        this.view = deviceView;
        this.pinpad = new PinpadImpl(deviceView, deviceName) {
            @Override
    ...
    public void loadKey() {
        ...
        if (result) {
            view.displayInfo("load pin key[D0FB24EA73F599C1D0FB24EA73F599C1] success");
        } else {
            view.displayInfo("load pin key[D0FB24EA73F599C1D0FB24EA73F599C1] fail");
        }
        ...
        if (result) {
            view.displayInfo("load td key[16B2CCB944DA2CE916B2CCB944DA2CE9] success");
        } else {
            view.displayInfo("load td key[16B2CCB944DA2CE916B2CCB944DA2CE9] fail");
        }
